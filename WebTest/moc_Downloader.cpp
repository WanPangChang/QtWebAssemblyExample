...
QT_MOC_LITERAL(1, 11, 8), // "receData"
...
QT_MOC_LITERAL(5, 50, 5) // "reply"
    ...
    "Downloader\0receData\0\0replyFinished\0"
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Downloader::receData)) {
                *result = 0;
                return;
            }
        }
